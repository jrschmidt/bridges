...
var BridgeDraw, BridgesApp, ConnectionHelper, DrawHelper, LocationFinder, PointsList;
...
BridgesApp = (function() {
  function BridgesApp(base) {
    ...
    this.locFind = new LocationFinder;
...
DrawHelper = (function() {
  ...
  DrawHelper.prototype.getXY = function(a, b) {
    var x, y;
    x = 30 + 25 * a;
    y = 30 + 25 * b;
    return [x, y];
