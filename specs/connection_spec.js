...
describe("Connection functions", function() {
  beforeAll(function() {
    ...
    return this.connect = new ConnectionHelper(this.boardHelper);
  });
  ...
  it("should combine two chains when a new bridge joins them together", function() {
  ...
  return it("should know when one side makes a complete end to end connection", function() {
    this.chGreen = new ConnectionHelper(this.boardHelper);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 8, 6);
    this.chGreen.addBridge('red', 11, 11);
    this.chGreen.addBridge('green', 3, 13);
    this.chGreen.addBridge('red', 4, 14);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 4, 6);
    this.chGreen.addBridge('red', 9, 13);
    this.chGreen.addBridge('green', 5, 7);
    this.chGreen.addBridge('red', 13, 11);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 10, 6);
    this.chGreen.addBridge('red', 8, 12);
    this.chGreen.addBridge('green', 3, 11);
    this.chGreen.addBridge('red', 5, 3);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 8, 8);
    this.chGreen.addBridge('red', 10, 12);
    this.chGreen.addBridge('green', 7, 7);
    this.chGreen.addBridge('red', 7, 13);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 6, 8);
    this.chGreen.addBridge('red', 3, 3);
    this.chGreen.addBridge('green', 1, 3);
    this.chGreen.addBridge('red', 15, 5);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 1, 1);
    this.chGreen.addBridge('red', 2, 4);
    this.chGreen.addBridge('green', 1, 5);
    this.chGreen.addBridge('red', 5, 7);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 3, 9);
    this.chGreen.addBridge('red', 7, 3);
    this.chGreen.addBridge('green', 3, 15);
    this.chGreen.addBridge('red', 2, 6);
    expect(this.chGreen.winner()).toEqual('none');
    this.chGreen.addBridge('green', 1, 7);
    this.chGreen.addBridge('red', 15, 11);
    this.chGreen.addBridge('green', 2, 8);
    expect(this.chGreen.winner()).toEqual('green');
    this.chRed = new ConnectionHelper(this.boardHelper);
    expect(this.chRed.winner()).toEqual('none');
    this.chRed.addBridge('green', 8, 6);
    this.chRed.addBridge('red', 11, 11);
    this.chRed.addBridge('green', 3, 13);
    this.chRed.addBridge('red', 4, 14);
    expect(this.chRed.winner()).toEqual('none');
    this.chRed.addBridge('green', 4, 6);
    this.chRed.addBridge('red', 9, 13);
    this.chRed.addBridge('green', 5, 7);
    this.chRed.addBridge('red', 13, 11);
    expect(this.chRed.winner()).toEqual('none');
    this.chRed.addBridge('green', 10, 6);
    this.chRed.addBridge('red', 8, 12);
    this.chRed.addBridge('green', 3, 11);
    this.chRed.addBridge('red', 5, 3);
    expect(this.chRed.winner()).toEqual('none');
    this.chRed.addBridge('green', 8, 8);
    this.chRed.addBridge('red', 10, 12);
    this.chRed.addBridge('green', 7, 7);
    this.chRed.addBridge('red', 7, 13);
    expect(this.chRed.winner()).toEqual('none');
    this.chRed.addBridge('green', 6, 8);
    this.chRed.addBridge('red', 3, 15);
    this.chRed.addBridge('green', 3, 3);
    this.chRed.addBridge('red', 1, 15);
    expect(this.chRed.winner()).toEqual('none');
    this.chRed.addBridge('green', 3, 1);
    this.chRed.addBridge('red', 15, 11);
    this.chRed.addBridge('green', 7, 5);
    this.chRed.addBridge('red', 5, 13);
    return expect(this.chRed.winner()).toEqual('red');
  });
});
