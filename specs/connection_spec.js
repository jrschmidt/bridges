...
describe("Connection functions", function() {
  it("should find connecting neighbors for a gameboard point", function() {
    var boardHelper, connect, points;
    ...
    expect(points).toContain([2, 6]);
    return expect(points).toContain([4, 6]);
  });
  return xit("should add a link to the list of chains");
});
